...
res_root = "/home/ghadeer/Projects/SegFormer/results/SberMerged_b0_160000_masks/"
...
#################################################################
src_palette = Image.open("datasets/Sber3500/all_palette.png")
...
for name in images:
    ...
    #################################################################
    trans_mask = trans_mask.quantize(palette=src_palette)
    #################################################################

    trans_mask = trans_mask.resize(all_mask.size, Image.BILINEAR)
    # trans_mask.show()
