...
class SberSegmentationAll(SegmentationDataset):
    ...
    def __init__(self, root='datasets/Sber2400', split='test', mode=None, transform=None, **kwargs):
        super(SberSegmentationAll, self).__init__(root, split, mode, transform, **kwargs)
...
if __name__ == '__main__':
    train_dataset = SberSegmentationAll()
